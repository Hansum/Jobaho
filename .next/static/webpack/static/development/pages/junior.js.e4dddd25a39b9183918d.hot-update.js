...
function searchJob(_ref2) {
  var _this2 = this;

  var value = _ref2.value;
  // const { query } = useRouter();
  var router = Object(next_router__WEBPACK_IMPORTED_MODULE_2__["useRouter"])();
  var keyword = router.push(value);

  var _useSWR = Object(swr__WEBPACK_IMPORTED_MODULE_3__["default"])("/api/juniorAPI".concat(keyword.length > 0 ? "?keyword=" + keyword : ""), fetcher),
      data = _useSWR.data,
      error = _useSWR.error;
  ...
  if (!data) return __jsx(_components_LoadingLayout__WEBPACK_IMPORTED_MODULE_7__["default"], {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 61,
...
//# sourceMappingURL=junior.js.e4dddd25a39b9183918d.hot-update.js.map