...
function FetchData() {
  ...
  var _useSWR = Object(swr__WEBPACK_IMPORTED_MODULE_4__["default"])("/api/juniorAPI", fetcher),
      data = _useSWR.data,
      error = _useSWR.error; // const { data, error } = useSWR("/api/juniorAPI", fetcher);
  ...
  console.log("Input value:", setValue);
...
//# sourceMappingURL=junior.js.73fa7028ba8fb0a58b38.hot-update.js.map